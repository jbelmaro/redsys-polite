  ...
  return /******/ (function (modules) {
    ...
    /******/ [
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        exports.codeToMessage =
          _error_codes.codeToMessage /* jshint esversion:6 */
            ...
            },
            {
              ...
              value: function build() {
                ...
                if (
                  ...
                  throw new Error(
                    'Urls to return from Redsys shoud be setted properly'
                  )
                }
          ...
          _createClass(Redsys, [
            ...
            },
            {
              ...
              value: function encodeOrder(order_id, secret) {
                ...
                // var res =
                //   cipher.update(order_id, 'utf8', 'base64') +
                //   cipher.final('base64');

                var res =
                  cipher.update(order_id, 'utf8', 'binary') +
                  cipher.final('binary')
                var l = Math.ceil(order_id.length / 8) * 8
                return Buffer.from(res.substr(0, l), 'binary').toString(
                  'base64'
                )
                // return res;
              },
            },
            {
              ...
              value: function doSignature(order_encoded, merchantData) {
                var hexMac256 = _crypto2.default
            ...
            },
            {
              ...
              value: function _decodeNotifiedMerchantParams(
                signature,
                merchantData
              ) {
                var _this = this
                ...
                return new Promise(function (resolve, reject) {
                  var decodedData = JSON.parse(
                    new Buffer(merchantData, 'base64')
                  )
                  var key = _this.encodeOrder(
                    decodedData.Ds_Order,
                    _this.secret
                  )
                  var hexMac256 = _crypto2.default
            ...
            },
            {
              ...
              value: function getFormData(payment) {
                ...
                var merchant = new Buffer(
                  JSON.stringify(this.generateMerchantParams(payment))
                ).toString('base64')

                // Calculate signature
                var order_encoded = this.encodeOrder(
                  payment.order_id,
                  this.secret
                )
